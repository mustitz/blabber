...
В нашому прикладі ми написали функцію двічі:
один раз в ідеальному світі на CoQ,
другий раз у брутальному світі програмування на Сі,
а потім довели еквівалентність.
Чи обов'язково кожного разу робити роботу двічі?
Ні, це не обов'язково.
Наприклад, для верифікації сортування достатньо довести дві властивості:
для любого елемента його кількість не зміниться,
та кожен елемент не більше наступного.
Такі властивості не залишають інших варіантів:
функція або сортує, або не проходить верифікацію.
